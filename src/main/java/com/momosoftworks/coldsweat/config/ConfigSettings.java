    ...
    static
    {
                                                           ...
                                                           (decoder) ->
        {
            ...
            return list;
                                                           ...
                                                           saver -> WorldSettingsConfig.setSourceSpreadWhitelist(saver.stream().map(ForgeRegistries.BLOCKS::getKey).collect(Collectors.toList())));
                                                           ...
                                                           (decoder) ->
        {
            ...
            return list;
                                                           ...
                                                           saver -> WorldSettingsConfig.setSourceSpreadBlacklist(saver.stream().map(ForgeRegistries.BLOCKS::getKey).collect(Collectors.toList())));
