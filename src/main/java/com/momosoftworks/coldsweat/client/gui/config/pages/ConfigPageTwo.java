...
public class ConfigPageTwo extends AbstractConfigPage
{
    ...
    protected void init()
    {
        ...
        // Show Water Effect
        this.addButton("show_water_effect", Side.LEFT, () -> getToggleButtonText(new TranslationTextComponent("cold_sweat.config.show_water_effect.name"), ConfigSettings.SHOW_WATER_EFFECT.get()),
