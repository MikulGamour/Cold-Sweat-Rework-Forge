...
public class ConfigPageFive extends AbstractConfigPage
{
    ...
    protected void init()
    {
        ...
        // Smart Icebox
        this.addButton("smart_icebox", Side.LEFT, () -> getToggleButtonText(new TranslatableComponent("cold_sweat.config.smart_source.name"), ConfigSettings.SMART_ICEBOX.get()),
        ...
        // Icebox Range
        this.addDecimalInput("icebox_range", Side.LEFT, new TranslatableComponent("cold_sweat.config.source_range.name"),
        ...
        // Icebox Max Range
        this.addDecimalInput("icebox_max_range", Side.LEFT, new TranslatableComponent("cold_sweat.config.source_max_range.name"),
        ...
        // Icebox Max Volume
        this.addDecimalInput("icebox_max_volume", Side.LEFT, new TranslatableComponent("cold_sweat.config.source_max_volume.name"),
        ...
        // Icebox Warm Up Time
        this.addDecimalInput("icebox_warm_up_time", Side.LEFT, new TranslatableComponent("cold_sweat.config.source_warm_up_time.name"),
